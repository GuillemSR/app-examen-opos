...
function App() {
  ...
  const getInitialHasRestoredExam = () => {
    if (typeof window === 'undefined') return false;
    return Boolean(localStorage.getItem('examState'));
  };
  const [hasRestoredExam, setHasRestoredExam] = useState(getInitialHasRestoredExam);
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl font-semibold text-foreground">Cargando preguntas...</p>
        </div>
        <ThemeToggle theme={theme} onToggle={toggleTheme} />
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header con timer */}
      <div className="bg-surface shadow-sm sticky top-0 z-40 border-b border-border">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 md:py-8">
        <div className="space-y-6">
          ...
          <button
            ...
            className="btn-success w-full py-4 flex items-center justify-center gap-2"
          >
